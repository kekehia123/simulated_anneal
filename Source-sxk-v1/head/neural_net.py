...
class TwoLayerNet(object):
    ...
    def train_sa(self, X, y, X_val, y_val,
        ...
        for it in xrange(num_iters):
            ...
            self.params['W1'] = W1 + step_len * np.random.uniform(-1, 1, W1.shape)
            self.params['b1'] = b1 + step_len * np.random.uniform(-1, 1, b1.shape)
            self.params['W2'] = W2 + step_len * np.random.uniform(-1, 1, W2.shape)
            self.params['b2'] = b2 + step_len * np.random.uniform(-1, 1, b2.shape)
